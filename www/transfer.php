...
<body>
    ...
    <section id="transfer" class="container">
        <form class="transfer-form" action="./receipt.php" method="POST">
            <h2>Giao dịch an toàn</h2>
            <ul>
                <label for="phoneNumber">Số điện thoại</label>
                <input class="transfer-input" type="number" name="phoneNumber" placeholder="Phone Number">
            </ul>
            <ul>
                <label for="money">Số tiền</label>
                <input class="transfer-input" type="number" name="money" placeholder="0.000đ">
            </ul>
            <div >
                <h4 class="cost-bearer">Người chịu phí:</h4>
                <span class="cost-bearer-name">
                    <select name="cost">
            ...
            <ul>
                ...
                <textarea name="content" id="" cols="23" rows="5" placeholder="Your Message"></textarea>
            </ul>
            <ul>
                <button type="submit" class="btn1" name="send" id="send" >Chuyển ngay</button>
            </ul>
        </form>
    </section>
        ...
        <div class="flex-direction">
            <div class="reason-box">
                ...
                <div class="reaContent">
                    ...
                    <p><i class="fa-solid fa-circle-check checked-icon"></i> Dễ sử dụng và kèm theo hướng dẫn bên dưới
                    </p>
