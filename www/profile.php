...
<body>
    ...
    <div class="info-box">
      ...
      <div class="user-info">
        ...
        <div class="upload_image">
          <h3>Ảnh CMND mặt trước:</h3>
          <p><img src="./images/user1.jpg" class="CMND-img front"></p>
        </div>
      </div>
      ...
      <div class="user-verify">
        ...
        <div class="upload_image">
          <h3>Ảnh CMND mặt sau: </h3>
          <p><img src="./images/user1.jpg" class="CMND-img back"></p>
        </div>
      </div>
    </div>
    <div class="info-box-btn">
      <button class="btn-info-1" onclick="acceptUser(<?=$_GET['user']?>)">Đồng Ý</button>
      <button class="btn-info-2" onclick="declineUser(<?=$_GET['user']?>)">Vô hiệu hóa</button>
      <button class="btn-info-3" onclick="additionalDoc(<?=$_GET['user']?>)">Bổ sung giấy tờ</button>
      <button class="btn-info-4" onclick="lockUser(<?=$_GET['user']?>)">Khóa vô thời hạn</button>
      <form action="admin.php">
        <button class="btn-info-5">Quay lại</button>
      </form>
    </div>
  </section>
  ...
  <script>
    <?php echo "const username = '".$_GET['user']."';"; ?>
